...
function processGet(req,res) {
  var occ = retrieveOccupations();
  var response = new ResponseBuilder();
    response.setStatus(200).setData(occ);
  res.status(response.status).json(response.build());
}

//No db here, we just return an array, that is all. Sigh...
function retrieveOccupations() {
  return occupations;
}

//https://www.careerdimension.com/SampleOccupations/FullOccupationList.cfm
var occupations = ["Able Seamen",
"Account Collector",
